...
echo "<h2> Excluir posts </h2>";
?>
<form action="adm_excluipubli_verify.php" method="post">
    ...
    <?php
        ...
        $res2 = mysqli_query($con,"select * from materias;");  //esta parte ira mostrar uma tabela como todos posts pedentes a ser liberados.
